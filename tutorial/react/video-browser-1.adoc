...
[NOTE]
====
The server on http://localhost:3000 will live reload everytime you save any files in the project. Make it a habit to do so on every change you during the course of this tutorial.
