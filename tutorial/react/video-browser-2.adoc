...
This is good and we can leave the matter of searching for a while. Let's start focusing on the video list and it's items by start putting these components together. Lets start with the parent of the two, `<VideoList/>`
