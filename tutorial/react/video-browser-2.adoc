...
----
[NOTE]
Any input you make to search bar should now be turn up in the console log

It is also possible to use the condensed arrow function instead, this allows us to inline the function directly in the onChange event:
