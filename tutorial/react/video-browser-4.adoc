...
If you are in the flow and don't feel like stopping quite yet, we have a bonus for you. Head over to https://reactjs.org/docs/state-and-lifecycle.html and walk through the content there. You will learn more about state, especially lifecycle methods, a concept we haven't covered. 
